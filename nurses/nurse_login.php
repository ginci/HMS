        ...
        <body class="account-pages">
            ...
            <div class="wrapper-page account-page-full">
                                ...
                                <form class="form-horizontal form-material" id="recoverform" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    ...
                                    <div class="form-group m-b-20 row">
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" type="username" name="nurse_username"  placeholder="Enter your Username">
                                        </div>
                                    </div>
                ...
                <div class="m-t-40 text-center">
                    <p class="account-copyright">2018 © AntenantalCare Parklane</p>
                </div>
