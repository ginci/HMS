...
<?php
    ...
    // getting all doctors
    $response1 = get_today_appointment();
    if ($response1 !== false) {
        $appoints = $response1;
    }
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                <div class="page-title-box">
                                    <h4 class="page-title">Card Enrollment </h4>
                                    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (isset($appoints)) {
                                            ...
                                            foreach ($appoints as $appoint) {
                                                ...
                                                $appoint_card_id = $appoint['card_id'];
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $appoint_card_id; ?></td>
                                            ...
                                            <td>
                                                <form method="POST" action="patient_profile.php">
                                                    ...
                                                    <input type="hidden" value="<?php echo "$appoint_card_id"; ?>" name="card_id">
