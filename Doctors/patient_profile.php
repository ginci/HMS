                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="profile-user-box card-box bg-custom">
                                <div class="row">
                                   ...
                                   data-overlaySpeed="200" data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Report</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="custom-modal" class="modal-demo">
                            ...
                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="report" required class="form-control" id="name" placeholder="Enter Patients Physical Examination Reports">
                                    </div>
                                    <div class="form-group">
                                        <label for="position">Prescription</label>
                                        <textarea placeholder="Enter Report" name="prescription" class="form-control" rows="2"></textarea>
                                    </div>
                                    <input type="hidden" name="card_id" value="<?php echo $card_id; ?>">
                                    <input type="hidden" name="patient_name" value="<?php echo $patient_fullname; ?>">
