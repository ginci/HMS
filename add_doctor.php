...
<div class="row">
    <div class="col-sm-4" style="padding-bottom: 20px;">
         <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg" ><i class="mdi mdi-plus"></i> Add Doctor</button>
    </div><!-- end col -->
</div>
    <!-- end row -->
    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <!--   <a href="options.php?doc_id=<?php echo $doc_id; ?>" class="btn btn-default waves-effect waves-float waves-green"><i class="dripicons-pencil"></i></a>
                                        ...
                                        <a href="options.php?delete_doc=<?php echo $doc_id; ?>" class="btn btn-default waves-effect waves-float waves-red"><i class="dripicons-trash"></i></a>
                                    </td>
                                </tr>
                               <?php }} ?>
                            </tbody>
                 ...
                 <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" name="specialization" required class="form-control" id="spec" placeholder="Enter Specilization">
                        </div>
                        <div class="col-sm-4 form-group">
                     ...
                     <div class="row">
                        <div class="col-sm-4 form-group">
                            <label for="position">Day</label>
                            <select class="form-control" name="day" >
                                <option selected>Select working days</option>
                                <option value="Monday&Wednesday">MON & WED</option>
                                <option value="Tuesday&Thursday">TUE & THURS</option>
                                <option value="Friday&Saturday">FRI & SAT(Half day)</option>   
                            </select>
                        </div>
                        <div class="col-sm-4 form-group">
