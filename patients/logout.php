    ...
    <body class="account-pages">
        ...
        <div class="wrapper-page account-page-full">
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            ...
                            <div class="text-center m-b-20">
                                ...
                                <p class="text-muted font-14 m-t-10"> You are now successfully sign out. Back to <a href="patient_login.php" class="text-dark m-r-5"><b>Login</b></a></p>
                                <p class="text-muted font-14 m-t-10"> You can go Back to <a href="../../" class="text-dark m-r-5"><b>Home</b></a></p>
                            </div>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">2019 © AntenantalCare Parklane</p>
            </div>
